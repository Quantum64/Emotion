package co.q64.emotion.compression.png.pixels;

import co.q64.emotion.compression.deflate.JavaDeflate;
import co.q64.emotion.compression.png.IDatChunkWriter;
import co.q64.emotion.compression.png.PngjOutputException;
...
public class CompressorStreamDeflater extends CompressorStream {
	...
	protected JavaDeflate deflater;
	...
	public CompressorStreamDeflater(IDatChunkWriter idatCw, int maxBlockLen, long totalLen, JavaDeflate def) {
		super(idatCw, maxBlockLen, totalLen);
		this.deflater = def == null ? new JavaDeflate() : def;
	...
	public CompressorStreamDeflater(IDatChunkWriter idatCw, int maxBlockLen, long totalLen, int deflaterCompLevel, int deflaterStrategy) {
		this(idatCw, maxBlockLen, totalLen, new JavaDeflate(deflaterCompLevel));
