...
import co.q64.emotion.compression.png.FilterType;
...
public abstract class PixelsWriter {
	 ...
	 */
	final protected byte[] filterRowWithFilterType(FilterType _filterType, byte[] _rowb, byte[] _rowbprev, byte[] _rowf) {
